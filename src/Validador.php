...
abstract class Validador
{
    ...
    public static function validacaoCpf($value): bool
    {
    ...
    public static function validacaoData($value): bool
    {
    ...
    public static function validacaoNumero($value): bool
    {
        if (!is_numeric($value)) {
            return false;
        }
    ...
    public static function validacaoTelefone($value): bool
    {
    ...
    public static function validacaoString($value): bool
    {
    ...
    public static function validacaoSanizar($value): bool
    {
        if (
            stripos($value, '#') !== false ||
            stripos($value, '@') !== false ||
    ...
    public static function validacaoEmail($value): bool
    {
    ...
    public static function validacaoObrigatoria($value): bool
    {
    ...
    public static function validar(array $vaiSerValidado, array $regras)
    {
        foreach ($regras as $indice => $regra) {
            ...
            try {
                $valor = $vaiSerValidado[$indice];
            }catch (\Throwable $exception) {
                static::quebrarValidacao($indice, 'É obrigatório');
            }
            foreach ($regra as $rule) {
                $metodo = $rule['metodo'];

                $resultadoValidacao = static::$metodo($valor);
